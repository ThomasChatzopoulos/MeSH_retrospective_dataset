 ...
 * @author tasosnent
 */
public class SCRHandler extends DefaultHandler {
    ...
    private String basicElementList = "";
    ...
    SCRHandler(JsonArrayProcessor processor) {
...
//      For those elements, the field name will have a prefix "Parent_FieldName", e.g. "kinetics_text" instead of just "text"
        ...
        this.conflictFields.add("DescriptorReferredTo");
...
//      entity is the basic entity. Hence, for entity, no prefix will be used (i.e. no prefix, means Entry for a conflict)
        this.basicElement = "SupplementalRecord"; // Actually, this is the "entity" element
        this.basicElementList = "SupplementalRecordSet"; // Actually, this is the "entity" element
...
//      Those will be String fields in the harvested objects  
        this.storedAsStr.add("SupplementalRecordUI");
        this.storedAsStr.add("SupplementalRecordName_String");
...
//      Those will be Arrays of Strings in the harvested objects  
        ...
        this.storedAsStrArrays.add("Concept~PreferredConceptYN");
        this.storedAsStrArrays.add("ConceptRelation~RelationName");
        this.storedAsStrArrays.add("Concept2UI"); // This is the related ConceptUI, the Concept1UI is of the preferred concept
        this.storedAsStrArrays.add("HeadingMappedTo_DescriptorReferredTo_DescriptorUI");
        this.storedAsStrArrays.add("HeadingMappedTo_DescriptorReferredTo_DescriptorName_String");
        this.storedAsStrArrays.add("QualifierUI");
        this.storedAsStrArrays.add("Term_String");
    }
...
//            System.out.println("New Entry Object created" );
            ...
            if(!this.insideField(this.basicElement)){//it's not a entity sub-Entity
                if (this.getFieldName().equals(basicElementList)) {//The beginig of the process
                    System.out.println("\t *** New SupplementalRecord Hravesting Start ***" );
                } else {
                    //XML formar error
...
//            System.out.println("entity instance nullified" );
            ...
            if(this.insideField(this.basicElement)){//exiting an Entity belonging to entity
                ...
                if (this.getFieldName().equals(basicElementList)) {//The end of the process
